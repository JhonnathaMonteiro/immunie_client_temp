...
const Network = ({ data, className, t, ...rest }: ViewComponentProps): JSX.Element => {
    ...
    <div className={className} {...rest}>
      <Grid container spacing={isMd ? 4 : 2}>
        <Grid item container justify="center" xs={12} md={6} data-aos="fade-up">
          <Image src="/static/images/illustrations/blockchain_technology.svg" />
        </Grid>
...
export default withTranslation('healthCarePage')(Network);
