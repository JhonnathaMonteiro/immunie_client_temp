  ...
  return (
    <div className={clsx(classes.root, className)} {...rest}>
      <div className={classes.hero}>
            ...
            <CardBase withShadow liftUp align="left" className={classes.card}>
              ...
              <List disablePadding>
                <ListItem disableGutters>
                  <ListItemAvatar>
                    <Avatar
                      src="/static/images/photos/dra_adriana.jpg"
                      srcSet="/static/images/photos/dra_adriana@2x.jpg"
        ...
        <Image
          src="/static/images/photos/health_mockup_2.png"
...
export default withTranslation('healthCarePage')(About);
